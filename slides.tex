...
\begin{frame}{Motivation - Rotating tidal-turbines\section{Motivation}}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{seaflow.jpg}
...
\begin{frame}{Representation of Dynamical Domains}
  \begin{columns}
    ...
    \begin{figure}
      \includegraphics[width=\linewidth]{singlemesh.png}
    ...
    \column{0.5\linewidth}
    \begin{figure}
      \includegraphics[width=\linewidth]{multimesh.png}
...
\begin{frame}{Overlapping meshes\section{Overlapping meshes}}
  \begin{columns}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\linewidth]{overlapmesh.png}
...
\begin{frame}{Coupling between overlapping domains and meshes}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{domain_mesh.png}
...
\begin{frame}{FEniCS and dolfin-adjoint\section[Applications]{Applications in FEniCS with dolfin-adjoint}}
  \begin{figure}
    \includegraphics[height=0.15\textheight,left]{fenics.png}
  \end{figure}
  \begin{itemize}
  ...
  \end{itemize}
  \begin{figure}
    \includegraphics[height=0.15\textheight,left]{dolfin_adjoint.png}
  \end{figure}
  \begin{itemize}
...
\begin{frame}{Meshes used for the optimal Poisson problem}
  \begin{columns}
    \column{0.5\linewidth}
    \begin{figure}
      \includegraphics[width=\linewidth]{meshpoi.png}
      \caption{Mesh used in dolfin for Optimization with a single mesh.}
    \end{figure}
    \column{0.5\linewidth}
    \begin{figure}
      \includegraphics[width=\linewidth]{multimeshpoi.png}
...
\begin{frame}{Results for Poisson-optimization}
  \begin{columns}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\linewidth]{f_exact.png}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\linewidth]{f_mm.png}
...
\begin{frame}{Results for Poisson-optimization}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{L2control.png}
...
\begin{frame}{Heat equation with moving domain}
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{heatsympic.png}
...
\begin{frame}{Investigation of the gradient of a goal functional}
  ...
  \end{align*}
  \begin{figure}
    \includegraphics[width=0.6\linewidth]{dJdu0.png}
...
\begin{frame}{Further Work\section{Further Work}}
  \begin{figure}
    \includegraphics[height=0.15\textheight,left]{forskningsradet.png}
  \end{figure}
  \begin{itemize}
  ...
  \end{itemize}
  \begin{figure}
    \includegraphics[height=0.15\textheight,left]{opentidalfarm.jpg}
    \begin{itemize}
